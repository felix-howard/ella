...
export function Sidebar() {
  ...
  const { canManageClients, canManagePayments, canViewTeam, avatarUrl } = useOrgRole()
  ...
  const navItems = getSidebarNavItems({ canManageClients, canManagePayments, canViewTeam })

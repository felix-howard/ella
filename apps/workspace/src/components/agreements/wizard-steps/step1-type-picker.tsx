 ...
 * 4 cards (NDA, Engagement Letter, Service Agreement, Custom). Click selects
...
import { FileSignature, FileText, Briefcase, FilePlus } from 'lucide-react'

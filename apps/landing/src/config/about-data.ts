/**
 * Data arrays for the About page — values, contact info.
 * Extracted from about.astro to keep page file under 200-line limit.
 * SVG paths are Heroicons outline 24x24.
 */

/** Core company values displayed as icon cards */
export const values = [
  {
    title: "AI for Efficiency, Not Replacement",
    description:
      "We believe AI should augment tax professionals, not replace them. Ella automates busywork so you can focus on high-value advisory work.",
    // Heroicons: sparkles
  ...
  {
    title: "Modern UX Matters",
    description:
      "Tax software doesn't have to be painful. We obsess over clean interfaces, intuitive workflows, and delightful user experiences.",
  ...
  },
  {
    ...
    description:
      "We understand tax workflows, compliance requirements, and multi-year client relationships. Ella is purpose-built for your industry.",
    // Heroicons: scale
  ...
  },
  {
    ...
    description:
      "Our roadmap is driven by customer feedback. We ship features tax professionals actually need, not what sounds cool on a pitch deck.",
    // Heroicons: heart
    icon: "M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z",
  },
] as const;

/** Social link definitions for contact section — TODO: replace with real URLs before production deploy */
export const socialLinks = [
  {
    label: "Twitter",
    href: "https://twitter.com/ella_tax",
    // Simplified Twitter/X icon path
    iconPath:
      "M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0 0 22 5.92a8.19 8.19 0 0 1-2.357.646 4.118 4.118 0 0 0 1.804-2.27 8.224 8.224 0 0 1-2.605.996 4.107 4.107 0 0 0-6.993 3.743 11.65 11.65 0 0 1-8.457-4.287 4.106 4.106 0 0 0 1.27 5.477A4.072 4.072 0 0 1 2.8 9.713v.052a4.105 4.105 0 0 0 3.292 4.022 4.095 4.095 0 0 1-1.853.07 4.108 4.108 0 0 0 3.834 2.85A8.233 8.233 0 0 1 2 18.407a11.616 11.616 0 0 0 6.29 1.84",
  },
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/ella-tax",
    // Simplified LinkedIn icon path
    iconPath:

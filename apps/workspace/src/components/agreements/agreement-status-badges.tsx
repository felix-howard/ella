 ...
 * Type colors: NDA=blue, EL=purple, SA=green, CUSTOM=gray.
 */
...
const agreementTypeStyles: Record<AgreementType, string> = {
  ...
  CUSTOM: 'bg-gray-100 text-gray-700 border-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-700',
}

export function AgreementTypeBadge({ type }: { type: AgreementType }) {
  const { t } = useTranslation()
  return (
    <span className={cn(baseBadge, agreementTypeStyles[type])}>

 ...
 * Displays detection notice and send button with message customization modal
 */
...
export function ScheduleCEmptyState({ caseId, clientName, count1099NEC, necBreakdown = [] }: ScheduleCEmptyStateProps) {

/**
 * Address Autocomplete - Custom dropdown using Google Places AutocompleteService
 * Uses the service API (not the deprecated widget) for full control over UI and values
 */

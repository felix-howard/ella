/**
 * Convert sanitized NDA HTML into react-pdf node tree.
 *
 ...
 *
 * Block tags emit `<View>` / `<Text>` siblings consumed by `NdaPdfDocument`
...
import { pdfStyles } from '../../services/nda/pdf-styles'

...
import { Pencil, Trash2, Loader2, FileText, Eye, ChevronUp, ChevronDown } from 'lucide-react'
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border">
              <SortableHeader label="Name" field="name" activeField={sortField} direction={sortDir} onSort={onSort} />
              ...
              <SortableHeader label="City" field="city" activeField={sortField} direction={sortDir} onSort={onSort} className="hidden md:table-cell" />
              <SortableHeader label="State" field="state" activeField={sortField} direction={sortDir} onSort={onSort} className="hidden md:table-cell" />
              <SortableHeader label="Status" field="status" activeField={sortField} direction={sortDir} onSort={onSort} />
...
function SortableHeader({ label, field, activeField, direction, onSort, className }: {
  label: string
  field: SortField
  ...
  return (
    <th
      className={cn(
        'text-left py-2 px-3 text-xs font-medium text-muted-foreground uppercase tracking-wider cursor-pointer select-none hover:text-foreground transition-colors',
        className
      )}

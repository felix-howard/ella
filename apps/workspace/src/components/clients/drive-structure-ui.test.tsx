...
const options = {
  ...
  staffOptions: [{ id: 'staff_1', name: 'Grace Hopper', email: 'grace@example.com' }],
  existingFolder: null,
}
...
describe('Drive structure workspace UI', () => {
  it('hydrates modal defaults from the Drive options response', () => {
  ...
  it('disables creation when Drive is not connected and replaces the CTA with links when ready', () => {
    ...
    const ready = renderToStaticMarkup(
      <DriveStructureStatus folder={{
        ...
        corpAdminFolderId: 'admin_1', corpAdminFolderWebUrl: 'https://drive.example/admin', sharedFolderId: 'shared_1', sharedFolderWebUrl: 'https://drive.example/shared',
